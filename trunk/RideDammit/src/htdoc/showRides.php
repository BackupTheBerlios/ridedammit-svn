...
<TR>
 ...
 <TH class="tbLogHeader">Rider</TH>
 <TH class="tbLogHeader">Bike</TH>
 <TH class="tbLogHeader">Location</TH>
<!--  <TH class="tbLogHeader">Type</TH> -->
...
<?php
   ...
   while ( $rides->parseNextRow($result) )
   {
      ...
      echo "<TD class=\"tbLogBody\">".
            fixFieldForHTML($rides->f_bikeID_bike,0)."</TD>";
      echo "<TD class=\"tbLogBody\">".
           "<img width='16' height='16' src=\"".
            $rides->f_locationID_type.".png\">&nbsp; ".
            fixFieldForHTML($rides->f_locationID_location,0)."</TD>";
//      echo "<TD class=\"tbLogBody\">$rides->f_locationID_type</TD>";
      echo "<TD class=\"tbLogBody\">".
      ...
      //echo "<TD class=\"tbLogBody\">".
      //      number_format($rides->f_temperature,1).
      //      "/$rides->f_wind/$rides->f_sky</TD>";
      echo "</TR>\n";
      echo "<TR>";
...
<table class="tbLog" width="80%" border=0 cellpadding=3 cellSpacing=3>
 <tbody>
  <tr>
   <td class="tbLogHeader">Rider</td>
   <td class="tbLogHeader">Rides</td>
